...
public class Kondoria extends Enemy {
    ...
    public void getEnemeImage() {
        try {
            ...
            up1 = ImageIO.read(getClass().getResourceAsStream("/Enemy/Kondoria/kondoria_left1.png"));
            up2 = ImageIO.read(getClass().getResourceAsStream("/Enemy/Kondoria/kondoria_left1.png"));
            down = ImageIO.read(getClass().getResourceAsStream("/Enemy/Kondoria/kondoria_right1.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/Enemy/Kondoria/kondoria_right1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/Enemy/Kondoria/kondoria_right1.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
